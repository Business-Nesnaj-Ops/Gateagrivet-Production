...
export const products: Product[] = [
  ...
  /*Plant Protein*/
  {
    ...
    fullDescription: 'A high-purity, high-protein corn concentrate produced by Cargill, designed primarily for aquaculture diets while equally beneficial to Livestock like Poultry, Swine and Pet Foods. It contains a high concentration of protein (~80%), making it a sustainable protein source that can replace more expensive protein sources like fishmeal. This product offers flexibility in diet design and is known for its superior binding and physical characteristics, promoting growth and health in animals while maintaining nutritional consistency.',
   content:' Crude Protein Content: 75% Best source of Crude Protein at 75% , CPC is A high-purity, high-protein corn concentrate produced by Cargill, designed primarily for aquaculture diets while equally beneficial to Livestock like Poultry, Swine and Pet Foods. It contains a high concentration of protein making it a sustainable protein source that can replace more expensive protein sources like fishmeal. This product offers flexibility in diet design and is known for its superior binding and physical characteristics, promoting growth and health in animals while maintaining nutritional consistency.',
  ...
  },
  {
    ...
    content:'Crude Protein Content: 65% A Fermented Corn Protein Bio Active Peptides. MOTIV is the dried proteinaceous fraction of the corn and corn extractives from the wet milling industry. The corn extractives and proteinaceous fraction are a result of the steep fermentation process and separation processes of corn in the wet milling industry. The proteinaceous fraction from the corn is concentrated primarily from the endosperm after the removal of the majority of the non-protein components by enzymatic solubilization. The proteinaceous fraction shall be processed with the corn extractives as they undergo the naturally occurring fermentation by lactic acid producing microorganisms as practiced in the wet mill. The resulting fermented proteinaceous fraction shall not contain less than 68% protein on a free moisture basis.',
    content:'Crude Protein Content: 65%',
    category: 'Plant Protein',
  ...
  },
  {
    ...
    content:'Crude Protein Content: 33%',
    category: 'Plant Protein',
  ...
  },
  {
    ...
    content:'Crude Protein Content: 37%',
    category: 'Plant Protein',
  ...
  /*Other Products*/
  {
    ...
    content:'Crude Protein Content: 48%',
