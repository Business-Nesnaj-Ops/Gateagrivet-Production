...
export const products: Product[] = [
  ...
  /*Plant Protein*/
  {
    ...
    fullDescription: 'A high-purity, high-protein corn concentrate produced by Cargill, designed primarily for aquaculture diets while equally beneficial to Livestock like Poultry, Swine and Pet Foods. It contains a high concentration of protein (~80%), making it a sustainable protein source that can replace more expensive protein sources like fishmeal. This product offers flexibility in diet design and is known for its superior binding and physical characteristics, promoting growth and health in animals while maintaining nutritional consistency. Crude Protein Content: 75% Best source of Crude Protein at 75% , CPC is A high-purity, high-protein corn concentrate produced by Cargill, designed primarily for aquaculture diets while equally beneficial to Livestock like Poultry, Swine and Pet Foods. It contains a high concentration of protein making it a sustainable protein source that can replace more expensive protein sources like fishmeal. This product offers flexibility in diet design and is known for its superior binding and physical characteristics, promoting growth and health in animals while maintaining nutritional consistency.',
