...
const carouselData = [
  {
    ...
    description: 'Primary source of protein for animal feeds and pet diets. They are rich in proteins and highly digestible, packed with calcium, phosphorus, essential fatty acids, minerals and vitamins. Excellent source of amino acids and highly sought for palatability aside from being popular protein ingredients in animal nutrition',
    buttonText: 'Shop Now',
    buttonLink: '/products',
  ...
  {
    id: 2,
    title: 'MARINE PROTEINS',
    description: 'Similar to various Animal Proteins, marine sources proteins meals are essential source of energy, protein, complex carbohydrates, healthy fats for endcurance, strength and lean meat building in animal feeds diets.',
